...
export default function PrototypeDemo({url}:{url:string}){
 ...
 Object.entries({'embed-host':'share','footer':'false','show-proto-sidebar':'false','device-frame':'false','scaling':'scale-down','viewport-controls':'false','hide-ui':'1','hotspot-hints':'true'}).forEach(([key,value])=>embed.searchParams.set(key,value));
