...
export default function PrototypeDemo({url}:{url:string}){
 ...
 Object.entries({'embed-host':'winnie-portfolio','footer':'false','show-proto-sidebar':'false','device-frame':'false','scaling':'fit-width','viewport-controls':'false','hide-ui':'1','hotspot-hints':'true'}).forEach(([key,value])=>embed.searchParams.set(key,value));
